...
def receiveOnePing(mySocket, ID, timeout, destAddr):
    ...
    while 1:
        ...
        type, code, checksum, packID, seq = struct.unpack("bbHHh", icmpHeader)
        # print("ICMP Header: ", type, code, checksum, packID, seq)
